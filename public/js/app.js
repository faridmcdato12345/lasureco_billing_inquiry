...
$('#show_bill').click(function () {
  if ($('#bill_period').val() == '') {
    ...
    getUserInfo($(this).val()).then(function (resolve) {
      showPowerBill(resolve.account_no, $('#bill_period').val()).then(function (resolve) {
        var status = resolve[0].mr_status == 0 ? 'Unpaid' : 'Paid';
        var dueDate = new Date(resolve[0].mr_due_date);
        var discDate = new Date(resolve[0].mr_discon_date);
        var formatter = new Intl.NumberFormat('en-US', {
          style: 'currency',
          currency: 'PHP'
        });
        var dataDiv = '<h5 class="mb-2 text-sm sm:text-2xl md:text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Result</h5>' + '<hr>' + '<table class="table">' + '<tbody>' + '<tr>' + '<td><b>Bill Status:</b></td>' + '<td class="bill-result">' + status + '</td>' + '</tr>' + '<tr>' + '<td><b>Bill Date:</b></td>' + '<td class="bill-result">' + resolve[0].mr_date_year_month + '</td>' + '</tr>' + '<tr>' + '<td><b>Due Date:</b></td>' + '<td class="bill-result">' + dueDate.toDateString() + '</td>' + '</tr>' + '<tr>' + '<td><b>Disconnection Date:</b></td>' + '<td class="bill-result">' + discDate.toDateString() + '</td>' + '</tr>' + '<tr>' + '<td><b>Previous Reading:</b></td>' + '<td class="bill-result">' + resolve[0].mr_prev_reading + '</td>' + '</tr>' + '<tr>' + '<td><b>Present Reading:</b></td>' + '<td class="bill-result">' + resolve[0].mr_pres_reading + '</td>' + '</tr>' + '<tr>' + '<td><b>KWH Used:</b></td>' + '<td class="bill-result">' + resolve[0].mr_kwh_used + '</td>' + '</tr>' + '<tr>' + '<td><b>Bill Amount:</b></td>' + '<td class="bill-result">' + formatter.format(resolve[0].mr_amount) + '</td>' + '</tr>' + '</tbody>';
        '</table>';
...
window.onload = function () {
  var ex = '/check/user/account'; // let urlUpdate = url.replace(':id',$('#user-account').val())
...
function toggleModal() {
  ...
  var modalEl = document.getElementById("authentication-modal");
...
$(document).ready(function () {
  getArrears().then(function (response) {
    var formatter = new Intl.NumberFormat('en-US', {
      style: 'currency',
      currency: 'PHP'
    });
  ...
  $('#full_name').focusout(function () {
    if ($(this).val() == '') {
      ...
      checkFullName($(this).val()).then(function (response) {
  ...
  $('#current_pass').focusout(function () {
    if ($(this).val() == '') {
      ...
      checkCurrentPassword($(this).val()).then(function (response) {
...
$(document).on('click', '.change-password-user', function () {
  var userAccount = $('#user-account').val();
  ...
  if (npass.localeCompare(c_npass) != 0) {
    ...
    var ex = '/logout';
    userChangePass(npass, $('#current_pass').val(), userAccount).then(function (response) {
      $.ajax({
        method: 'POST',
        url: rootDirectory(ex),
...
/******/ 	__webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./resources/js/bill.js")))
